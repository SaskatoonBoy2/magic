const SETS = {
    ...
    ADVENTURESINTHEFORGOTTENREALMS: 'afr',
    AETHERREVOLT: 'aer',
    ALARAREBORN: 'arb',
    ALLIANCES: 'all',
    ALLWILLBEONE: 'one',
    ...
    APOCALYPSE: 'apc',
    AVACYNRESTORED: 'avr',
    BATTLEFORZENDIKAR: 'bfz',
    BLESSEDVSCURSED: 'ddq',
    BORNOFTHEGODS: 'bng',
    BROTHERSWAR: 'bro',
    BROTHERSWARRETROARTIFACTS: 'brr',
    ...
    COMMANDER2020: 'c20',
    COMMANDER2021: 'c21',
    COMMANDERLEGENDS: 'cmr',
    CONFLUX: 'con',
    CONSPIRACY: 'cns',
    CONSPIRACYTAKETHECROWN: 'cn2',
    CORE2010: 'm10',
    CORE2011: 'm11',
    CORE2012: 'm12',
    CORE2013: 'm13',
    ...
    HEROSVSMONSTERS: 'ddl',
    HOMELANDS: 'hml',
    HOUROFDEVISTATION: 'hou',
    ICEAGE: 'ice',
    ICONICMASTERS: 'ima',
    INNISTRAD: 'isd',
    INNISTRADMIDNIGHTHUNT: 'mid',
    INVASION: 'inv',
    IXALAN: 'xln',
    IZZETVSGOLGARI: 'ddj',
    JACEVSVRASKA: 'ddm',
    ...
    KALADESH: 'kld',
    KALDHEIM: 'khm',
    KAMIGAWANEONDYNASTY: 'neo',
    KHANSOFTARKIR: 'ktk',
    LORWYN: 'lrw',
    MAGICORIGINS: 'ori',
    MASTERS25: 'a25',
    MERCADIANMASQUES: 'mmq',
    MERFOLKVSGOBLINS: 'ddt',
    MIRAGE: 'mir',
    MIRRODIN: 'mrd',
    MIRRODINBESIEGED: 'mbs', 
    MODERNHORIZONS: 'mh1', 
    MODERNMASTERS2017: 'mm3',
    MORNINGTIDE: 'mor',
    NEMESIS: 'nem',
    NEONDYNASTYCOMMANDER: 'nec',
    NEWPHYREXIA: 'nph',
    NINTH: '9ed',
    OATHOFTHEGATEWATCH: 'ogw',
    ODYSSEY: 'ody',
    ONSLAUGHT: 'ons',
    PHYREXIAVSCOALITION: 'dde',
    PLANECHASE: 'hop',
    PLANESHIFT: 'pls',
    PORTAL: 'por',
    PORTALSECONDAGE: 'p02',
    ...
    SEVENTH: '7ed',
    SHADOWMOOR: 'shm',
    SHADOWSOVERINNISTRAD: 'soi',
    SHARDSOFALARA: 'ala',
    SORINVSINNISTRAD: 'ddk',
    TEMPEST: 'tmp',
    TENTH: '10e',
    THEDARK: 'drk',
    THEROS: 'ths',
    THEROSBEYONDDEATH: 'thb',
    TIMESPIRAL: 'tsp',
    TIMESPIRALREMASTERED: 'tsr',
    TORMENT: 'tor',
    TRANSFORMERS: 'bot',
    UNHINGED: 'unh',
    URZASDESTINY: 'uds',
